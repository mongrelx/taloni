...
- [~] [#23](https://github.com/mongrelx/taloni/issues/23) — Web dashboard (seuranta-issue; osittain: Vue-pohjainen web-UI toteutettu, tarjoillaan `taloni serve`:stä — kiinteistöt (vain luku), tehtävät (lisäys + tila), hälytykset, salkku. Loput TUI:n 9 välilehden mukaisesta CRUD-kattavuudesta pilkottu 8 alaissueeksi: [#43](https://github.com/mongrelx/taloni/issues/43) kiinteistö-CRUD + tehtävien muokkaus/poisto, [#44](https://github.com/mongrelx/taloni/issues/44) Talous & Korjaukset, [#45](https://github.com/mongrelx/taloni/issues/45) Sähkö & Kulutus, [#46](https://github.com/mongrelx/taloni/issues/46) Vakuutus & Kalusto, [#47](https://github.com/mongrelx/taloni/issues/47) Määräaikaishuolto, [#48](https://github.com/mongrelx/taloni/issues/48) Polttopuu & Sauna, [#49](https://github.com/mongrelx/taloni/issues/49) Vuokraus & Kausi, [#50](https://github.com/mongrelx/taloni/issues/50) Yhteystiedot & Arkisto)
...
- [ ] [#43](https://github.com/mongrelx/taloni/issues/43) — Web UI: property CRUD + task edit/delete (osa #23:a)
- [ ] [#44](https://github.com/mongrelx/taloni/issues/44) — Web UI: Talous & Korjaukset -välilehti (osa #23:a)
- [ ] [#45](https://github.com/mongrelx/taloni/issues/45) — Web UI: Sähkö & Kulutus -välilehti (osa #23:a)
- [ ] [#46](https://github.com/mongrelx/taloni/issues/46) — Web UI: Vakuutus & Kalusto -välilehti (osa #23:a)
- [ ] [#47](https://github.com/mongrelx/taloni/issues/47) — Web UI: Määräaikaishuolto-välilehti (osa #23:a)
- [ ] [#48](https://github.com/mongrelx/taloni/issues/48) — Web UI: Polttopuu & Sauna -välilehti (osa #23:a)
- [ ] [#49](https://github.com/mongrelx/taloni/issues/49) — Web UI: Vuokraus & Kausi -välilehti (osa #23:a)
